...
int energy0 = 3000;	/* Starting Energy */
...
char torps0 = 10;	/* Photon Torpedo capacity */
int quad_y, quad_x;		/* Quadrant Position of Enterprise */
int shield;			/* Current shield value */
char stars;			/* Stars in quadrant */
int time_start;		/* Starting Stardate */
int time_up;		/* End of time */
int damage[9];			/* Damage Array */
int d4;			/* Used for computing damage repair time */
int ship_y, ship_x;		/* Current Sector Position of Enterprise, fixed point */
int stardate;		/* Current Stardate */
...
void complete_maneuver(int warp, int n)
{
	int time_used;
