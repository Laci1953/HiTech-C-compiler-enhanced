...
void sub_013d(register FILE *p) 
{
    ...
    if (s_opt != 0)
        /* emitSrcInfo(); */
	CallOverlay0(emitSrcInfo, 32+4);
}

/**************************************************
 * 2: 01C1 PMO +++
 **************************************************/
void sub_01c1(register sym_t *p_arg) 
{
    sym_t buf;
...
void sub_0353(sym_t *p_arg, char c) 
{
	     ...
	     st = /* st->nMemberList */ (sym_t*)GetWord((char*)st, OFF_nMemberList)) 
	{
            ...
            /* sub_7454(&st->attr); */
	    CallOverlay2(sub_7454, &st->attr, true, 32+6);
...
void sub_0493(register sym_t *st) 
{
	...
	CallOverlay2(sub_7454, &st->attr, true, 32+6);
        ...
        if (/* st->m20 */ (m20 = GetByte((char*)st, OFF_m20)) == (char)D_6)
            ...
            c = *keywords[(unsigned)/* (unsigned)st->m20 */ m20 - 19];
...
void sub_05f1(register expr_t *st) 
{
        ...
        switch (st->tType) 
	{
        case T_ID:
            var4 = st->t_pSym;
            if (/* var4->m20 */ GetByte((char*)var4, OFF_m20) == D_CONST) 
	    {
                printf(". `");
        ...
        case S_TYPE:
            /* sub_7454(&st->attr); */
	    CallOverlay2(sub_7454, &st->attr, false, 32+6);
            break;
        case T_FCONST:
            printf(".%s", st->t_s);
            break;
            ...
            !(/* var6->t_pSym->m18 */ GetWord((char*)(var6->t_pSym), OFF_m18) & 1)) 
	{
            printf("* # ");
            /* sub_7454(&var6->attr); */
	    CallOverlay2(sub_7454, &var6->attr, false, 32+6);
            putchar(' ');
