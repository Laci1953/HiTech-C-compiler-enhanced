...
#else
	AddToList((char*)&hashtab[ComputeHashEntry(buf)], (char*)ps);
#endif
    }
...
#else
       		AddToList((char*)&hashtab[index], (char*)tmp2);
#endif
...
//    }
    ...
    if (!pn || !tmp)
	fatalErr(100, "Out of memory in upper RAM");
...
#else
        var4 = (sym_t*)GetFirstSym((char*)(hdr = (char*)&hashtab[n]));
#endif
...
#else
    var4 = (sym_t*)GetFirstSym(hdr = (char*)&SymList);
#endif
...
#else
    AddToList((char*)&SymList, (char*)st);
#endif
