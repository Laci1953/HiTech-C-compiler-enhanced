...
#define logOptimise(n) (hasChanged = true)
...
// s must be sym_t*
#define GetLabel(s) ((((char*)s<(char*)0x4000)&&((char*)(s+1)>(char*)0x3FE0)) ? ((char*)0xC000) : (char*)(s+1))
...
//extern list_t             * freeItemList;             
extern char               * allocs;
extern char               * programBreak;
extern term_t 		    exprResult;			/* so pointer to term can be returned */
...
#define		optimise		(char*)0x4000
#define		sub_404d		(char*)0x4003
#define		loadFunction		(char*)0x4006
#define		chkIXYUsage		(char*)0x4009
#define		sub_0ed1		(char*)0x400C
#define		sub_122f		(char*)0x400F
#define		sub_15ad		(char*)0x4012
