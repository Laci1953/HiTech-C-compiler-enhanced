...
;
?2X64K	equ	0	;1 : SC108 or 32KB ROM + 128KB RAM Phillip Stevens memory module
...
;void*	myalloc(void)
;	
;	Alloc operand in 8 x 16KB / 2 x 32KB RAM
;
...
ENDIF
	...
	ex	de,hl		;HL=Buf
	push	hl		;save-it
	ld	bc,OFF_DATA	;first fill-it with 0
	add	hl,bc
	ld	b,6		;6 bytes to erase
erase:	ld	(hl),0
	inc	hl
	djnz	erase
	pop	hl		;HL=buf
