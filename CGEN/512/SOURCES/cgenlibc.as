...
;
DEBUG	equ	0		;prints each byte sent to a file
...
;	ASsign Logical Long Left SHift
	...
	global	asallsh, aslllsh, allsh, liregstore
...
aslllsh:
	...
	jp	liregstore	; go store the value and return
...
;	ASsign Arithmetic Long Right  SHift
	...
	global	asalrsh, alrsh, liregstore
...
;=========================================================
	...
	global	liregset, liregstore, asaladd, aslladd, aladd
...
;=========================================================
	...
	global	liregset, liregstore, asaland, aslland, aland
...
;	ASsign Logical Long Right  SHift
	...
	global	asllrsh, llrsh, liregstore
...
;=========================================================
	...
	global	liregset, liregstore, asalmul, asllmul, almul
...
;=========================================================
	psect	text
	global	liregset, liregstore, asalor, asllor, alor
...
;=========================================================
	...
	global	liregset, liregstore, asalsub, asllsub, alsub
...
;=========================================================		
	...
	global	liregset, liregstore, asalxor, asllxor, alxor
...
1:	ld	hl,(memtop)
	...
	add	hl,de
	ld	a,h
	cp	40H		;if we reached 4000H...
	jr	nz,3f
	ld	hl,0C000H	;...switch to 0C000H
3:
	ld	(memtop),hl
	pop	hl
	ret
...
memtop:	defw	03E00H		;we start allocating from here
;
;=========================================================
; 781E exit
;=========================================================
