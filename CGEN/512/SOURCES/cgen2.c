...
void sub_2D09(register node_t *sa, char *p2, char p3) 
{
        ...
        switch (lc7) 
	{
		...
		CallOverlay2L_(sub_2CE0, la2, la2->info.l, 32+5);
            else if (la2->a_c0 == FCONST)
	    {
		ReadMem(tmpBuf, la2->info.sv.s, 32);
                printf("%s", tmpBuf);
	    }
            else
                printf("%s", GetString((char*)(la2->info.mp[0]), OFF_b_name));
        ...
        case 'Z':
            ...
            goto m46;
        case 'B':
            ll9 = /* sub_387A(la2) */ CallOverlay1(sub_387A, la2, 32+5);
        m46:
            if (ch == '-') 
	    {
                if (lc11 == 0) 
        ...
        case 'A':
            /* sub_153A(la2); */
	    CallOverlay1(sub_153A, la2, 32+5);
            break;
        case 'V':
            if (ch == '-' || ch == '+') 
	    {
                if (lc11 == 0) 
		{
            ...
            m54:
                ll13 += ch == '-' ? -1L : 1L;
                if (/* sub_14F3(la2) */ (char)CallOverlay1(sub_14F3, la2, 32+5) == 2 && 
		    nodesize(la2) < 4)
		...
		CallOverlay2L_(sub_2CE0, la2, la2->info.l >> (lc5 * 8), 32+5);
            }
            break;
	    ...
	    {
                ll9 = la2->info.l;
                if (/* sub_46F7(ll9) */ (char)CallOverlay1L(sub_46F7, ll9, 32+5) == 0)
                    ll9 = ~ll9;
                word_AFF8 += (/* sub_46F7(ll9) */ (char)CallOverlay1L(sub_46F7, ll9, 32+5) - 1) / 8;
            }
            break;
        case 'T':
            if (la2->a_c0 == BFIELD)
            ...
            else 
	    {
                ...
                if (/* sub_46F7(ll9) */ (char)CallOverlay1L(sub_46F7, ll9, 32+5) == 0)
                    ll9 = ~ll9;
                printf("%d", /* sub_46F7(ll9) */ (char)CallOverlay1L(sub_46F7, ll9, 32+5) - 1);
            }
            break;
        case 'G':
        case 'X':
 ...
 *********************************************************/
void O_sub_3564(register node_t *sa) 
{
    char l1;
