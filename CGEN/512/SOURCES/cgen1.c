 ...
 *			       sub_3DC9
 *********************************************************/
void O_sub_2BD0(register node_t *sa) 
{
    int tmp;

    sa->a_c1 = 0;

    if (/* sub_1F4B(sa, 0x48, word_B017, 0, &tmp) */ 
	CallOverlay5(sub_1F4B, sa, 0x48, word_B017, 0, &tmp, 32+4) <= 0)
 ...
 *********************************************************/
void O_sub_2CE0(node_t *p1a, long p2) 
{
