 ...
 *********************************************************/
int O_sub_1F4B(node_t *p1a, int p2, int p3, int p4, int *p5) 
{
    ...
    do 
    {
        ...
        if (sz->c_0 != 0 && 
	    /* sub_47B2(p1a, sz->c_0) */ CallOverlay2(sub_47B2, p1a, sz->c_0, 32+5) == 0)
            continue;
        ...
        if ((uint8_t)sz->c_3 >= 'H') 
	{
            ...
            if (/* sub_1F4B(p1a, (uint8_t)sz->c_3, p3, l6, &l2) */
		CallOverlay5(sub_1F4B, p1a, (uint8_t)sz->c_3, p3, l6, &l2, 32+4) < 0) 
	    {
                p1a->a_c1 = 0;
                continue;
            }
	...
	else if (sz->c_4 != 0) 
	{
            ...
            if (/* sub_1F4B(p1a->info.np[0], (uint8_t)sz->c_4, p3, l6, &l2) */
		CallOverlay5(sub_1F4B, p1a->info.np[0], (uint8_t)sz->c_4, p3, l6, &l2, 32+4) < 0)
                continue;
            if (sz->c_5 != 0) 
	    {
                ...
                if (l7 == 0) 
		{
                ...
                if (/* sub_1F4B(p1a->info.np[1], sz->c_5, p3, l7, &l3) */
		    CallOverlay5(sub_1F4B, p1a->info.np[1], sz->c_5, p3, l7, &l3, 32+4) < 0) /* 29B3 */
                    continue;
                ...
                if (l4 & l8) 
		{
                    ...
                    if (/* sub_1F4B(p1a->info.np[1], sz->c_5, p3 & ~l8, l7, &l3) */
			CallOverlay5(sub_1F4B, p1a->info.np[1], sz->c_5, p3 & ~l8, l7, &l3, 32+4) <= 0)
                        continue;
                    l4 = sub_2B2A(p1a->info.np[1]);
                }
