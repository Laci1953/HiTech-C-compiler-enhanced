...
int sub_808(member_t *sb, node_t *p2a) {
    int16_t l1;
    int16_t l2;
    member_t *l3b;
    member_t *l4b;
		    ...
		    l1 % ++l2 != 0) {
                ...
                if (/* l4b->b_sloc */ GetByte((char*)l4b, OFF_b_sloc) & 0x10) {
                    ...
                    if (/* l4b->b_b6 */ GetByte((char*)l4b, OFF_b_b6) != 0)
                        //l6a = sub_43EF(BOR, l6a, sub_43EF(LSHIFT, p2a, sub_415E(0L)));	/* bug !!! */
			l6a = sub_43EF(BOR, l6a, sub_43EF(LSHIFT, p2a, sub_415E(/* l4b->b6 */ GetByte((char*)l4b, OFF_b_b6) )));
                    else
                        l6a = p2a;
 ...
 *********************************************************/
void sub_153A(node_t *sa) {

    static char array_A542[] = { 0, 'a', 'l', 'f' };

    putchar(array_A542[sub_14F3(sa)]);
}
 ...
 *********************************************************/
void sub_15FB(member_t *sb, int p2, int p3) {
    bool f = (p2 >= 0);
...
member_t *sub_1754(char *token, uint8_t cls) {
    ...
    if (/* sb->b_ndpth */ GetByte((char*)sb, OFF_b_ndpth) != nstdpth) {                 /* If nesting depth not correspond current,*/
        ...
        sb         = /* allocMem(sizeof(member_t)) */ (member_t*)MyAlloc();  /* hash table. Create new struct and save  */
	...
	PutWord((char*)sb, OFF_b_next, (short)*l1b);
        ...
        *l1b = sb;                                /* Save pointer to this struct in current  */
                                                  /* position hash table.		     */
        /* sb->b_name = (char*)MyAlloc(); */ /* allocMem(strlen(token) + 1); */ 
	PutWord((char*)sb, OFF_b_name, (short)(p = (char*)MyAlloc()));
